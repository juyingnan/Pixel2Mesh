...
flags.DEFINE_string('data_list', 'Data/test_list.txt', 'Data list.') # training data list
...
with open(FLAGS.data_list, 'r') as f:
	while(True):
		line = f.readline().strip()
		img_path = line.replace('.dat', '.png')
		if not line:
			break
		img_inp = load_image(img_path)
